...
func HandlePostJson(w http.ResponseWriter, r *http.Request) {
	...
	if get_result.Password != channel_password {
		...
		case "line":
			...
			Function.Linequery2(w, "test", "1647619751", "1647619831")
...
func Config_Workstation(configtype string, content []string, Doldfile bool) (string, error) {
	...
	case "androidonline":
		...
		_, err := Function.Lineinsert(content[0], content[1], content[2], content[3])
		if err != nil {
			return "insert md5 error", errors.New("onlineconfigerror")
		}
